...
Template.purchaseorderlistBO.onCreated(function() {
    ...
    templateObject.getDataTableList = function(data) {
        ...
        let productCost = utilityService.modifynegativeCurrencyFormat(data.LineCost) || 0.00;
        ...
        var dataList = [
            ...
            data.ETADate != '' ? moment(data.ETADate).format("DD/MM/YYYY") : data.ETADate,
            data.CustomerJob || '',
            data.QtySold || 0,
            productCost,
            totalAmountEx || 0.00,
    ...
    let headerStructure = [
        ...
        { index: 4, label: "Product Name", class: "colProductName", active: true, display: true, width: "200" },
        { index: 5, label: "Purchase Desc", class: "colPurchaseDesc", active: true, display: true, width: "300" },
        { index: 6, label: "ETA Date", class: "colETADate", active: true, display: true, width: "80" },
        { index: 7, label: "Customer Job", class: "colCustomerJob", active: false, display: true, width: "110" },
        { index: 8, label: "Qty", class: "colQty", active: true, display: true, width: "110" },
        { index: 9, label: "Cost", class: "colCost", active: true, display: true, width: "110" },
        { index: 10, label: "Amount (Ex)", class: "colAmountEx", active: false, display: true, width: "110" },
        { index: 11, label: "Tax", class: "colTax", active: false, display: true, width: "110" },
        { index: 12, label: "Amount (Inc)", class: "colAmount", active: false, display: true, width: "110" },
        { index: 13, label: "Paid", class: "colPaid", active: false, display: true, width: "110" },
        { index: 14, label: "Outstanding", class: "colBalanceOutstanding", active: false, display: true, width: "110" },
        { index: 15, label: "Custom Field 1", class: "colCustomField1", active: false, display: true, width: "110" },
        { index: 16, label: "Custom Field 2", class: "colCustomField2", active: false, display: true, width: "110" },
        { index: 17, label: "Employee", class: "colEmployee", active: false, display: true, width: "110" },
        { index: 18, label: "Comments", class: "colComments", active: true, display: true, width: "300" },
...
Template.purchaseorderlistBO.helpers({
    ...
    apiFunction:function() {
        let sideBarService = new SideBarService();
        return sideBarService.getAllTPurchasesBackOrderReportData;
    },

    searchAPI: function() {
        let sideBarService = new SideBarService();
        return sideBarService.getAllTPurchasesBackOrderReportDataBySupplierName;
    },
