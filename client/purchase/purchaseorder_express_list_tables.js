...
Template.purchaseorderlist.onCreated(function () {
  ...
  templateObject.getDataTableList = function(data) {
    let totalAmountEx = utilityService.modifynegativeCurrencyFormat( data.TotalAmountInc ) || 0.0;
    let totalTax = utilityService.modifynegativeCurrencyFormat( data.TotalTax ) || 0.0;
    let totalAmount = utilityService.modifynegativeCurrencyFormat( data.TotalAmount ) || 0.0;
    let totalPaid = utilityService.modifynegativeCurrencyFormat( data.Payment ) || 0.0;
    ...
    var dataList = [
      ...
      data.DueDate != "" ? moment(data.DueDate).format("YYYY/MM/DD") : data.DueDate,
  ...
  let headerStructure = [
    ...
    { index: 2, label: "Order Date", class: "colOrderDate", active: true, display: true, width: "80" },
    { index: 3, label: "P/O No.", class: "colPurchaseNo", active: true, display: true, width: "110" },
    ...
    { index: 10, label: "Employee", class: "colEmployee", active: true, display: true, width: "110" },
...
Template.purchaseorderlist.helpers({
  ...
  apiFunction:function() {
    let sideBarService = new SideBarService();
    return sideBarService.getAllTPurchaseOrderListData;
  },

  searchAPI: function() {
    let sideBarService = new SideBarService();
    return sideBarService.getPurchaseOrderListBySupplierName;
  },
