...
Template.transactiongrid.onRendered(function() {
    ...
    templateObject.init_reset_data = async function() {
        let reset_data = [
            ...
            { index: 12, label: "Cost",               class: "CostPrice",     width: "110",       active: true,   display: true },
            ...
            { index: 17, label: "Price (Ex)",         class: "UnitPriceEx",   width: "152",       active: true,   display: true },
            { index: 18, label: "Price (Inc)",        class: "UnitPriceInc",  width: "152",       active: false,  display: true },
