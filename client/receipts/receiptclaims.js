...
Template.receiptsoverview.onCreated(function () {
    ...
    templateObject.getDataTableList = function(data) {
        var dataList = [
            data.fields.ID || '',
            `<div class="custom-control custom-checkbox chkBox pointer" style="width:15px;"><input class="custom-control-input chkBox chkPaymentCard pointer" type="checkbox" id="formCheck-${data.fields.ID}"><label class="custom-control-label chkBox pointer" for="formCheck-${data.fields.ID}"></label></div>`,
            data.fields.DateTime != "" ? moment(data.fields.DateTime).format( "DD/MM/YYYY") : data.fields.DateTime,
            data.fields.SupplierName || '',
            utilityService.modifynegativeCurrencyFormat( data.fields.AmountInc ) || 0.0,
            data.fields.AccountName || '',
            data.fields.TripGroup || '',
            data.fields.Description || '',
            data.fields.Lines[0].fields.Reimbursement,
            data.fields.Lines[0].fields.SupplierID || '',
            data.fields.Lines[0].fields.AccountId || '',
            data.fields.Lines[0].fields.EmployeeID || '',
            data.fields.EmployeeName || '',
            data.fields.Lines[0].fields.TaxCode || '',
            utilityService.modifynegativeCurrencyFormat( data.fields.Lines[0].fields.Tax ) || 0.0,
            utilityService.modifynegativeCurrencyFormat( data.fields.Lines[0].fields.AmountEx ) || 0.0,
            utilityService.modifynegativeCurrencyFormat( data.fields.Lines[0].fields.AmountInc ) || 0.0,
            data.fields.Lines[0].fields.ID || '',
            data.fields.Active ? "" : "In-Actve",
        ];
        return dataList;
    }
    let headerStructure = [
        { index: 0, label: 'ID', class:'colId', active: false, display: true, width: "10" },
        { index: 1, label: '', class:'colChk', active: true, display: true, width: "10" },
        ...
        { index: 4, label: "Amount", class: "colAmount", active: true, display: true, width: "100" },
        { index: 5, label: "Account", class: "colAccount", active: true, display: true, width: "110" },
        { index: 6, label: "Trip-Group", class: "colTripGroup", active: true, display: true, width: "110" },
        { index: 7, label: "Description", class: "colDescription", active: true, display: true, width: "300" },
        { index: 8, label: "Reimbursement", class: "colReimbursement", active: false, display: true, width: "110" },
        { index: 9, label: "SupplierID", class: "colSupplierID", active: true, display: true, width: "10" },
        { index: 10, label: "AccountID", class: "colAccountID", active: false, display: true, width: "10" },
        { index: 11, label: "EmployeeID", class: "colEmployeeID", active: false, display: true, width: "10" },
        { index: 12, label: "EmployeeName", class: "colEmployeeName", active: false, display: true, width: "200" },
        { index: 13, label: "TaxCode", class: "colTaxCode", active: false, display: true, width: "110" },
        { index: 14, label: "TaxAmount", class: "colTaxAmount", active: false, display: true, width: "110" },
        { index: 15, label: "AmountEx", class: "colAmountEx", active: false, display: true, width: "110" },
        { index: 16, label: "AmountInc", class: "colAmountInc", active: false, display: true, width: "110" },
...
Template.receiptsoverview.helpers({
    ...
    apiFunction:function() {
        let accountService = new AccountService();
        return accountService.getExpanseClaimList;
    },
