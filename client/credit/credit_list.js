...
Template.creditlist.onCreated(function(){
    ...
    let headerStructure = [
        ...
        { index: 1, label: "Credit No.", class: "colPurchaseNo", active: true, display: true, width: "65" },
        ...
        { index: 9, label: "Comments", class: "colComments", active: false, display: true, width: "300" },
