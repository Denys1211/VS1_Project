...
templateObject.tableLeaveRequestheaderrecords.set(headerStructure);
  ...
  templateObject.getTransactionDataTableList = function(data) {
    var dataList = [
      ...
      utilityService.modifynegativeCurrencyFormat(data.fields.TotalAmountInc)|| 0.00,
      utilityService.modifynegativeCurrencyFormat(data.fields.TotalTax)|| 0.00,
      utilityService.modifynegativeCurrencyFormat(data.fields.TotalAmount)|| 0.00,
      utilityService.modifynegativeCurrencyFormat(data.fields.TotalPaid)|| 0.00,
    ...
    setTimeout(function () {
      ...
      $('#edtHolidays').editableSelect()
        ...
        $('#edtPayPeriod').editableSelect().on('click.editable-select', async function (e, li) {
          $('#payPeriodPopModal').modal("toggle");
        });
    }, 1000);
