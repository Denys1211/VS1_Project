...
Template.statementlist.onCreated(function () {
    ...
    let headerStructure = [
        ...
        { index: 2, label: "Job Name", class: "colJobName", active: true, display: true, width: "200" },
        { index: 3, label: "Balance", class: "colBalance", active: true, display: true, width: "110" },
        { index: 4, label: "Notes", class: "colNotes", active: true, display: true, width: "500" },
