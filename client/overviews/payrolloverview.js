...
Template.payrolloverview.onCreated(function () {
  ...
  templateObject.getDraftDataTableList = function(data) {
    var dataList = [
      ...
      moment(data.fields.RunDate).format("Do MMM YYYY") || "",
      moment(data.fields.MsTimeStamp).format("Do MMM YYYY") || "",
      utilityService.modifynegativeCurrencyFormat(data.fields.PayRunDetailsEmployeeEarnings)|| 0.00,
      utilityService.modifynegativeCurrencyFormat(data.fields.PayRunDetailsEmployeeTax)|| 0.00,
      utilityService.modifynegativeCurrencyFormat(data.fields.PayRunDetailsEmployeeSuperannuation)|| 0.00,
      utilityService.modifynegativeCurrencyFormat(data.fields.PayRunDetailsEmployeeNetPay)|| 0.00,
      data.fields.Complete ? "Completed" : "",
    ];
    return dataList;
  }
  let draftHeaderStructure = [
    { index: 0, label: 'ID', class: 'colID', active: false, display: true, width: "10" },
    { index: 1, label: 'Calendar', class: 'colCalendar', active: true, display: true, width: "110" },
    { index: 2, label: 'Period', class: 'colPeriod', active: true, display: true, width: "110" },
    { index: 3, label: 'Payment Date', class: 'colPaymentDate', active: true, display: true, width: "80" },
    { index: 4, label: 'Wages', class: 'colAmount', active: true, display: true, width: "110" },
    { index: 5, label: 'Tax', class: 'colTax', active: true, display: true, width: "110" },
    { index: 5, label: 'Super', class: 'colAmountEx', active: true, display: true, width: "110" },
    { index: 6, label: 'Net Pay', class: 'colPaid', active: true, display: true, width: "110" },
  ...
  templateObject.draftTableHeaderRecords.set(draftHeaderStructure);
    ...
    templateObject.getHistoryDataTableList = function(data) {
        ...
        let wages = utilityService.modifynegativeCurrencyFormat(data.fields.Wages)|| 0.00;
        let tax = utilityService.modifynegativeCurrencyFormat(data.fields.Tax)|| 0.00;
        let supper = utilityService.modifynegativeCurrencyFormat(data.fields.Superannuation)|| 0.00;
        let netPay = utilityService.modifynegativeCurrencyFormat(data.fields.Net)|| 0.00;
        let deleted = data.fields.Deleted ? "Deleted" : "";
        var dataList = [
            ID,
            calendar,
            period,
...
Template.payrolloverview.helpers({
  ...
  searchAPI: function() {
    let sideBarService = new SideBarService();
    return sideBarService.getTimeSheetListByEmployeeName;
  },
  ...
  draftSearchAPI: function() {
    let sideBarService = new SideBarService();
    return sideBarService.getAllPayRunDataByID;
  },
  ...
  historyTableHeaderRecords: () => {
    return Template.instance().historyTableHeaderRecords.get();
  },
  ...
  historySearchAPI: function() {
    let sideBarService = new SideBarService();
    return sideBarService.getPayHistoryDataByID;
  },
