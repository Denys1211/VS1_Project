...
export class ReportService extends BaseService {
    ...
    getBalanceSheetReport(limitCount, limitFrom, dateFrom, dateTo, ignoreDate,contactID) {
        let options = "";
    ...
    getGeneralLedgerDetailsData(limitCount, limitFrom, dateFrom, dateTo, ignoreDate,contactID) {
        let options = "";
        if(limitCount == undefined || limitCount == 'All') {
            if(contactID && contactID != ''){
                options = {
    ...
    getGeneralLedgerDataByKeyword(dateFrom, dateTo, ignoreDate) {
        let options = "";
        if (ignoreDate == true) {
            options = {
                IgnoreDates: true,
