...
Template.supplierreport.onRendered(() => {
  ...
  let reset_data = [
    { index: 1, label: 'Supplier', class: 'colSupplierID', active: true, display: true, width: "200" },
    ...
    // { index: 15, label: 'Bank Account BSB', class: 'colBankAccountBSB', active: true, display: true, width: "150" },
    // { index: 16, label: 'Bank Account No', class: 'colAccountNo', active: true, display: true, width: "150" },
    // { index: 17, label: 'Creation Date', class: 'colCreationDate', active: true, display: true, width: "150" },
    // { index: 18, label: 'Active', class: 'colActive', active: true, display: true, width: "150" },
    // { index: 19, label: 'Global Ref', class: 'colGlobalRef', active: false, display: true, width: "150" },
    // { index: 20, label: 'Street2', class: 'colStreet2', active: false, display: true, width: "150" },
    // { index: 21, label: 'Street3', class: 'colStreet3', active: false, display: true, width: "150" },
    // { index: 22, label: 'No Staff', class: 'colNoStaff', active: false, display: true, width: "150" },
    // { index: 23, label: 'Min Inv value', class: 'colMinInvValue', active: false, display: true, width: "150" },
    // { index: 24, label: 'Freight to Store', class: 'colFrighttoStore', active: false, display: true, width: "150" },
    // { index: 25, label: 'Rebate', class: 'colRebate', active: false, display: true, width: "150" },
    // { index: 26, label: 'First Name', class: 'colFirstName', active: false, display: true, width: "150" },
    // { index: 27, label: 'Last Name', class: 'colLastName', active: false, display: true, width: "150" },
    // { index: 28, label: 'Contact Details', class: 'colContractDetails', active: false, display: true, width: "150" },
    // { index: 29, label: 'ABN', class: 'colABN', active: false, display: true, width: "150" },
    // { index: 30, label: 'Print Name', class: 'colPrintName', active: false, display: true, width: "150" },
    // { index: 31, label: 'ClientID', class: 'colClientID', active: false, display: true, width: "150" },
  ];
