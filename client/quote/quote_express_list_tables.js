...
Template.quoteslist.onCreated(function(){
    ...
    templateObject.getDataTableList = function(data) {
        ...
        var dataList = [
            ...
            // custfield1: data.SaleCustField1 || '',
            // custfield2: data.SaleCustField2 || '',
            // custfield3: data.SaleCustField3|| '',
        ];
        return dataList;
    }
    let headerStructure = [
        { index: 0, label: 'ID', class:'colId', active: false, display: false, width: "10" },
        { index: 1, label: 'Sort Date', class:'colSortDate', active: false, display: false, width: "80" },
        { index: 2, label: "Sale Date", class: "colSaleDate", active: true, display: true, width: "80" },
        { index: 3, label: "Sales No.", class: "colSalesNo", active: true, display: true, width: "110" },
        { index: 4, label: "Due Date", class: "colDueDate", active: true, display: true, width: "80" },
        { index: 5, label: "Customer", class: "colCustomer", active: true, display: true, width: "110" },
        { index: 6, label: "Amount (Ex)", class: "colAmountEx", active: true, display: true, width: "110" },
        { index: 7, label: "Tax", class: "colTax", active: true, display: true, width: "110" },
        { index: 8, label: "Amount (Inc)", class: "colAmount", active: true, display: true, width: "110" },
        { index: 9, label: "Employee", class: "colEmployee", active: true, display: true, width: "200" },
        { index: 10, label: "Converted", class: "colConverted", active: false, display: true, width: "40" },
...
Template.quoteslist.helpers({
    ...
    searchAPI: function() {
        let sideBarService = new SideBarService();
        return sideBarService.getQuoteListByCustomerName;
    },
