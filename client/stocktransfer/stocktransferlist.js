...
Template.stocktransferlist.onCreated(function(){
    ...
    templateObject.getDataTableList = function(data){
        ...
        } else if (data.fields.Processed == false) {
            linestatus = "On Hold";
        };
        let dataList = [
            data.fields.ID || '',
    ...
    let headerStructure = [
        { index: 0, label: "Transfer No.", class: "colTransferNo", active: true, display: true, width: "80" },
        { index: 1, label: "ID", class: "colSortDate", active: false, display: true, width: "80" },
        { index: 2, label: "Creation Date", class: "colCreationDate", active: true, display: true, width: "80" },
        { index: 3, label: "Transfer From Dept", class: "colTransferDept", active: true, display: true, width: "200" },
        { index: 4, label: "Account Name", class: "colAccountName", active: true, display: true, width: "200" },
        { index: 5, label: "Transfer Date", class: "colAdjustmentDate", active: true, display: true, width: "80" },
        { index: 6, label: "Custom Field 1", class: "colSaleCustField1", active: false, display: true, width: "100" },
        { index: 7, label: "Custom Field 2", class: "colSaleCustField2", active: false, display: true, width: "100" },
...
Template.stocktransferlist.helpers({
    ...
    searchAPI: function() {
      return sideBarService.getAllStockAdjustEntryByName
    },
