...
//     'click .productionplannermodule .btnApply': async function(event) {
...
//     'click .productionplannermodule .btn-print-event': function(event) {
...
//     'click .productionplannermodule .btn-optimize': function(event) {
//         let templateObject = Template.instance();
...
//     'click .productionplannermodule .btn-raw-material': function(eve) {
//         let templateObject = Template.instance();
//         let events = templateObject.events.get();
//         for(let i = 0; i< events.length; i++) {
//             let event = events[i];
